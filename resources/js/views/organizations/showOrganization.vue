	...
	<div>
		<div v-if="organization"
			...
			<div class="organization-details">
				...
				<div class="people">
					<p class="director"><b>Director: </b>{{ organization.director[0].first_name }} {{ organization.director[0].last_name }}</p>
					<p class="poc"><b>Contact Person: </b>{{ organization.poc[0].first_name }} {{ organization.poc[0].last_name }}</p>
				</div>
				<div class="contact">
